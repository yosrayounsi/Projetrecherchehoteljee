...
<body>
    <div class="menu">
        <ul>
            ...
            <li>
                <a href="Addagent.jsp" class="active">
      ...
      <div class="main-header">
        ...
        <div class="main-form">
         ...
         <input type="hidden" name="action" value="ajouter">
            <input type="text" id="ftitle" name="username" placeholder="Add Username">
             <input type="text" id="flocation" name="password" placeholder="Add password">
              <input type="text" id="flocation" name="email" placeholder="Add email">
