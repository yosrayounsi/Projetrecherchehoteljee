...
<style>
.custom-input {
            /* Add any additional styling for your inputs */
            padding: 10px;
            margin-bottom: 10px;
            border: 2px solid #8a2be2; /* Violet border color */
            border-radius: 5px;
        }
        
  .custom-label {
            /* Add any additional styling for your labels */
            margin-bottom: 5px;
            color: #8a2be2; /* Violet color for labels */
            font-weight: bold;
        }
.table {
    width: 100%;
...
.table tr:hover {
    background-color: #f5f5f5; /* Hover row background color */
}
  ...
  <div class='dashboard'>
    <div class="dashboard-nav">
        ...
        <nav class="dashboard-nav-list"><a href="Agentdashboard.jsp" class="dashboard-nav-item "><i class="fas fa-home"></i>
            Home </a><a
                href="Addhotel.jsp" class="dashboard-nav-item "><i class="fas fa-tachometer-alt"></i>Add Hotel
        </a><a
                href="./HotelServlet" class="dashboard-nav-item active"><i class="fas fa-file-upload"></i> Check list hotels </a>
...
<form action="<c:url value='/HotelServlet'/>" method="get">
    <input type="hidden" name="action" value="rechercher">
    <label for="nom" class="custom-label">Name:</label><input type="text" name="nom" class="form-control custom-input"><br>
    <label for="ville" class="custom-label">City:</label> <input type="text" name="ville" class="form-control custom-input"><br>
   <label for="etoiles" class="custom-label">Stars:</label> <input type="number" name="etoiles" class="form-control custom-input"><br>
    <input type="submit" value="Search"class="modifier-buttonnn">
</form>


<div class="table-wrap">
<!-- Afficher la liste des hôtels -->
<c:if test="${not empty listeHotels}">
    <table class="table">
     <thead content-align="center" class="thead-primary">
        <tr>
            <th>ID</th>
            <th>Name</th>
            <th>City</th>
        ...
        <c:forEach var="hotel" items="${listeHotels}">
            <tr>
                <td>${hotel.id}</td>
                <td>${hotel.name}</td>
                <td>${hotel.city}</td>
         ...
         <td>
                   ...
                   <form action="<c:url value='Updatehotel.jsp'/>" method="post" style="display:inline;">
                        ...
                        <input type="submit" value="Update"class="modifier-button">
                    </form>
                     
                    </td>
                    <td>
                    <!-- Formulaire de suppression -->
                    <form action="<c:url value='/HotelServlet'/>" method="post" style="display:inline;">
                        <input type="hidden" name="action" value="supprimer">
                        <input type="hidden" name="id" value="${hotel.id}">
                        <input type="submit" value="Delete" class="modifier-buttonn">
                    </form>
                </td>
            </tr>
        </c:forEach>
