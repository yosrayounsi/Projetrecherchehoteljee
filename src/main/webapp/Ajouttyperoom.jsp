...
<body>
 <div class="menu">
        <ul>
            ...
            <li>
                <a href="listeaccount.jsp">
                    <i class="fas fa-user-plus"></i>
                    <p>Add Account</p>
                </a>
            </li>
            <li>
                <a href="Ajouttyperoom.jsp" class="active">
...
<form action="./AjoutetyperoomServlet" method="post">
 <input type="hidden" name="action" value="add">
    
    <input type="text" id="label" name="label" placeholder="input label" required><br>

 
    <input type="number" id="capacity" name="capacity" placeholder="input capacity" required><br>

            <input type="submit" id="fsubmit" value="Add" class="button">
</form>
</div>
      </div>
    </main>
