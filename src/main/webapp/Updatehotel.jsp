...
<div class='dashboard'>
    <div class="dashboard-nav">
        ...
        <nav class="dashboard-nav-list"><a href="Agentdashboard.jsp" class="dashboard-nav-item "><i class="fas fa-home"></i>
            Home </a><a
                ...
                <a
                href="Updatehotel.jsp" class="dashboard-nav-item active"><i class="fas fa-tachometer-alt"></i>Update Hotel
        </a>
    ...
    <form class="login__form" action="<c:url value='/HotelServlet'/>" method="post">
      <div class="login__form-row form-group">
        <input type="hidden" name="action" value="modifier">
        <input type="text" class="login__form-input form-control"   id="id" name="id" readonly>
           </div>
           <div class="login__form-row form-group">
             <input type="text" class="login__form-input form-control" id="name" name="name">
           </div>
             <div class="login__form-row form-group">
             <input type="text" class="login__form-input form-control" id="city" name="city">
           </div>
            <div class="login__form-row form-group">
             <input type="text" class="login__form-input form-control"id="stars" name="stars">
           </div>
            <div class="login__form-row form-group">
             <input type="text" class="login__form-input form-control" id="description" name="description">
           </div>
        <input type="submit" value="Save modifications" class="btn btn-default login__form-btn">
    </form>
         </div>
		</div>   
	</div>   
